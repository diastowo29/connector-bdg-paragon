...
var SwitchboardActionsApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(SwitchboardActionsApi, [{
     ...
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/ReleaseControlBody} [releaseControlBody] 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
  }, {
    key: "releaseControlWithHttpInfo",
    value: function releaseControlWithHttpInfo(appId, conversationId, opts) {
      opts = opts || {};
      var postBody = opts['releaseControlBody'];
      // verify the required parameter 'appId' is set
      if (appId === undefined || appId === null) {
    ...
    key: "releaseControl",
    value: function releaseControl(appId, conversationId, opts) {
      return this.releaseControlWithHttpInfo(appId, conversationId, opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
  }]);
