...
var ConversationsApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(ConversationsApi, [{
    ...
    key: "downloadMessageRefWithHttpInfo",
    value: function downloadMessageRefWithHttpInfo(appId, conversationId, downloadMessageRefBody) {
      var postBody = downloadMessageRefBody;
      // verify the required parameter 'appId' is set
      if (appId === undefined || appId === null) {
      ...
      return this.apiClient.callApi('/v2/apps/{appId}/conversations/{conversationId}/download', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    key: "downloadMessageRef",
    value: function downloadMessageRef(appId, conversationId, downloadMessageRefBody) {
      return this.downloadMessageRefWithHttpInfo(appId, conversationId, downloadMessageRefBody).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    key: "postConversionEventsWithHttpInfo",
    value: function postConversionEventsWithHttpInfo(appId, conversationId, conversionEventsBody) {
      var postBody = conversionEventsBody;
      // verify the required parameter 'appId' is set
      if (appId === undefined || appId === null) {
      ...
      return this.apiClient.callApi('/v2/apps/{appId}/conversations/{conversationId}/conversionEvents', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    key: "postConversionEvents",
    value: function postConversionEvents(appId, conversationId, conversionEventsBody) {
      return this.postConversionEventsWithHttpInfo(appId, conversationId, conversionEventsBody).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
