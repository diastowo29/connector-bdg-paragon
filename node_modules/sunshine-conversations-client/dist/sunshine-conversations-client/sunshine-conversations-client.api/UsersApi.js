...
var UsersApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(UsersApi, [{
     ...
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/SyncUserBody} [syncUserBody] 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sunshine-conversations-client/sunshine-conversations-client.model/UserResponse} and HTTP response
     */
  }, {
    key: "syncUserWithHttpInfo",
    value: function syncUserWithHttpInfo(appId, zendeskId, opts) {
      opts = opts || {};
      var postBody = opts['syncUserBody'];
      // verify the required parameter 'appId' is set
      if (appId === undefined || appId === null) {
      ...
      var accepts = ['application/json'];
      var returnType = _UserResponse["default"];
      return this.apiClient.callApi('/v2/apps/{appId}/users/{zendeskId}/sync', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    key: "syncUser",
    value: function syncUser(appId, zendeskId, opts) {
      return this.syncUserWithHttpInfo(appId, zendeskId, opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
