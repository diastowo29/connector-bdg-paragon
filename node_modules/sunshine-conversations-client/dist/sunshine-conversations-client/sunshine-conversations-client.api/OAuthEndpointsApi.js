...
var OAuthEndpointsApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
   ...
   * @param {String} [state] You may pass in any arbitrary string value here which will be returned to you along with the code via browser redirect.
   * @param {String} [redirectUri] You may pass in a redirect_uri to determine which URI the response is redirected to. This URI must be contained in the list configured by your integration. If this option is not passed, the first URI present in the list will be used.
  ...
  return _createClass(OAuthEndpointsApi, [{
     ...
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/GetTokenRequest} getTokenRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:sunshine-conversations-client/sunshine-conversations-client.model/GetToken200Response} and HTTP response
     */
  }, {
    key: "getTokenWithHttpInfo",
    value: function getTokenWithHttpInfo(getTokenRequest) {
      var postBody = getTokenRequest;
     ...
     * This endpoint is used to exchange an authorization code for an access token.  It should only be used in server-to-server calls.  Use `oauth-bridge.zendesk.com/sc` as the base URL when invoking this endpoint.  ``` POST https://oauth-bridge.zendesk.com/sc/oauth/token ``` 
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/GetTokenRequest} getTokenRequest 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:sunshine-conversations-client/sunshine-conversations-client.model/GetToken200Response}
     */
  }, {
    key: "getToken",
    value: function getToken(getTokenRequest) {
      return this.getTokenWithHttpInfo(getTokenRequest).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    key: "getTokenInfoWithHttpInfo",
    value: function getTokenInfoWithHttpInfo() {
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      var headerParams = {};
      ...
      return this.apiClient.callApi('/v2/tokenInfo', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getTokenInfo() {
      return this.getTokenInfoWithHttpInfo().then(function (response_and_data) {
        return response_and_data.data;
      });
    }
