...
var AttachmentsApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
  ...
  return _createClass(AttachmentsApi, [{
     ...
     * @param {String} [_for] Specifies the intended container for the attachment, to enable automatic attachment deletion (on deletion of associated message, conversation or user). For now, only message is supported. See [Attachments for Messages](#section/Attachments-for-Messages) for details.
     * @param {String} [conversationId] Links the attachment getting uploaded to the conversation ID.
