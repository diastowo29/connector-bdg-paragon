...
var FormResponseMessage = /*#__PURE__*/function () {
  ...
  function FormResponseMessage() {
    ...
    FormResponseMessage.initialize(this);
  }
   ...
   */
  return _createClass(FormResponseMessage, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>FormResponseMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormResponseMessage</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = FormResponseMessage;