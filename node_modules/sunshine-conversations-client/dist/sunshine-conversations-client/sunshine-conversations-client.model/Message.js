...
var _ActivityMessage = _interopRequireDefault(require("./ActivityMessage"));
...
var Message = /*#__PURE__*/function () {
  ...
  return _createClass(Message, [{
    ...
    /**
         * Returns Details of the system activity that generated this message. This field is used when actions taken by the system generate a persisted message to notify the user or agent of an event that occurred. For example, when a user's Ticket gets closed. This property applies only to informational text messages generated via system events.
         * @return {module:sunshine-conversations-client/sunshine-conversations-client.model/ActivityMessage}
         */
  }, {
    key: "getActivity",
    ...
    /**
     * Sets Details of the system activity that generated this message. This field is used when actions taken by the system generate a persisted message to notify the user or agent of an event that occurred. For example, when a user's Ticket gets closed. This property applies only to informational text messages generated via system events.
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/ActivityMessage} activity Details of the system activity that generated this message. This field is used when actions taken by the system generate a persisted message to notify the user or agent of an event that occurred. For example, when a user's Ticket gets closed. This property applies only to informational text messages generated via system events.
     */
  }, {
    key: "setActivity",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('activity')) {
          obj['activity'] = _ApiClient["default"].convertToType(data['activity'], _ActivityMessage["default"]);
        }
 ...
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/ActivityMessage} activity
 */
Message.prototype['activity'] = undefined;
