...
var AuthorWebhook = /*#__PURE__*/function () {
   ...
   */
  function AuthorWebhook() {
    _classCallCheck(this, AuthorWebhook);
    AuthorWebhook.initialize(this);
  }
   ...
   */
  return _createClass(AuthorWebhook, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>AuthorWebhook</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthorWebhook</code>.
     */
  }, {
    key: "validateJSON",
