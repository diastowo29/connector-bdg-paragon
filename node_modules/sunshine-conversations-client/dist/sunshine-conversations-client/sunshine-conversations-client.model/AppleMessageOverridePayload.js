 ...
 * @version 17.0.0
 */
var AppleMessageOverridePayload = /*#__PURE__*/function () {
  /**
   ...
   */
  function AppleMessageOverridePayload() {
    _classCallCheck(this, AppleMessageOverridePayload);
   ...
   */
  return _createClass(AppleMessageOverridePayload, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>AppleMessageOverridePayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppleMessageOverridePayload</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = AppleMessageOverridePayload;