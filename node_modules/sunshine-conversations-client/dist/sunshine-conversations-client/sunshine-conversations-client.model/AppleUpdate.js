...
var AppleUpdate = /*#__PURE__*/function () {
  ...
  return _createClass(AppleUpdate, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AppleUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppleUpdate</code>.
     */
  }, {
    key: "validateJSON",
