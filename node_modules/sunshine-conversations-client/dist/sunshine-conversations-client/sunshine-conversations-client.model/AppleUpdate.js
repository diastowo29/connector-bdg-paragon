...
var _AppleUpdateAllOf = _interopRequireDefault(require("./AppleUpdateAllOf"));
...
var AppleUpdate = /*#__PURE__*/function () {
  ...
  function AppleUpdate() {
    ...
    _AppleUpdateAllOf["default"].initialize(this);
   ...
   */
  return _createClass(AppleUpdate, [{
    key: "getDisplayName",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _AppleUpdateAllOf["default"].constructFromObject(data, obj);
 ...
 * @member {String} defaultResponderId
 */
_IntegrationUpdateBase["default"].prototype['defaultResponderId'] = undefined;
// Implement AppleUpdateAllOf interface:
/**
 * A secret used to create the state value when sending Apple authentication 2.0 messages
 * @member {String} authenticationMessageSecret
 */
_AppleUpdateAllOf["default"].prototype['authenticationMessageSecret'] = undefined;
