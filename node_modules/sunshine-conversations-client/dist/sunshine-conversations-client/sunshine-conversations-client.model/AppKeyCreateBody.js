...
var AppKeyCreateBody = /*#__PURE__*/function () {
   ...
   */
  function AppKeyCreateBody() {
    _classCallCheck(this, AppKeyCreateBody);
    AppKeyCreateBody.initialize(this);
  }
   ...
   */
  return _createClass(AppKeyCreateBody, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>AppKeyCreateBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppKeyCreateBody</code>.
     */
  }, {
    key: "validateJSON",
