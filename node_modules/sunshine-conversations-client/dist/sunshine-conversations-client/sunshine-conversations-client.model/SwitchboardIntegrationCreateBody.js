...
var SwitchboardIntegrationCreateBody = /*#__PURE__*/function () {
   ...
   */
  function SwitchboardIntegrationCreateBody() {
    _classCallCheck(this, SwitchboardIntegrationCreateBody);
    SwitchboardIntegrationCreateBody.initialize(this);
  }
   ...
   */
  return _createClass(SwitchboardIntegrationCreateBody, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>SwitchboardIntegrationCreateBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SwitchboardIntegrationCreateBody</code>.
     */
  }, {
    key: "validateJSON",
