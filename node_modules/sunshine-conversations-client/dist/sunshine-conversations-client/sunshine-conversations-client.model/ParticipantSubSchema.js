...
var ParticipantSubSchema = /*#__PURE__*/function () {
   ...
   */
  return _createClass(ParticipantSubSchema, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ParticipantSubSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParticipantSubSchema</code>.
     */
  }, {
    key: "validateJSON",
