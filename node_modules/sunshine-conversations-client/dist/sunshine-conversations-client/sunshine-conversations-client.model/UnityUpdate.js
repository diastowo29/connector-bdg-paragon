 ...
 * @version 17.0.0
 */
var UnityUpdate = /*#__PURE__*/function () {
  /**
  ...
  function UnityUpdate() {
    _classCallCheck(this, UnityUpdate);
   ...
   */
  return _createClass(UnityUpdate, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>UnityUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnityUpdate</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = UnityUpdate;