...
var LocationRequest = /*#__PURE__*/function () {
  ...
  function LocationRequest() {
    ...
    LocationRequest.initialize(this);
  }
   ...
   */
  return _createClass(LocationRequest, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>LocationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationRequest</code>.
     */
  }, {
    key: "validateJSON",
