...
var MatchCriteriaMailgun = /*#__PURE__*/function () {
   ...
   */
  function MatchCriteriaMailgun() {
    _classCallCheck(this, MatchCriteriaMailgun);
    MatchCriteriaMailgun.initialize(this);
  }
   ...
   */
  return _createClass(MatchCriteriaMailgun, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>MatchCriteriaMailgun</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchCriteriaMailgun</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = MatchCriteriaMailgun;