...
var _UserRemoveEventAllOf = _interopRequireDefault(require("./UserRemoveEventAllOf"));
var _UserRemoveEventAllOfPayload = _interopRequireDefault(require("./UserRemoveEventAllOfPayload"));
 ...
 */
/**
 * The UserRemoveEvent model module.
 * @module sunshine-conversations-client/sunshine-conversations-client.model/UserRemoveEvent
 * @version 16.0.1
 */
var UserRemoveEvent = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UserRemoveEvent</code>.
   * @alias module:sunshine-conversations-client/sunshine-conversations-client.model/UserRemoveEvent
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/EventSubSchema
   * @implements module:sunshine-conversations-client/sunshine-conversations-client.model/UserRemoveEventAllOf
   */
  function UserRemoveEvent() {
    _classCallCheck(this, UserRemoveEvent);
    _EventSubSchema["default"].initialize(this);
    _UserRemoveEventAllOf["default"].initialize(this);
    UserRemoveEvent.initialize(this);
  }
   ...
   */
  return _createClass(UserRemoveEvent, [{
    key: "getId",
    value:
    /**
    ...
    /**
     * Constructs a <code>UserRemoveEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/UserRemoveEvent} obj Optional instance to populate.
     * @return {module:sunshine-conversations-client/sunshine-conversations-client.model/UserRemoveEvent} The populated <code>UserRemoveEvent</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new UserRemoveEvent();
        _EventSubSchema["default"].constructFromObject(data, obj);
        _UserRemoveEventAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _UserRemoveEventAllOfPayload["default"].constructFromObject(data['payload']);
        }
      }
      return obj;
    }
...
// Implement UserRemoveEventAllOf interface:
/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/UserRemoveEventAllOfPayload} payload
 */
_UserRemoveEventAllOf["default"].prototype['payload'] = undefined;
var _default = exports["default"] = UserRemoveEvent;