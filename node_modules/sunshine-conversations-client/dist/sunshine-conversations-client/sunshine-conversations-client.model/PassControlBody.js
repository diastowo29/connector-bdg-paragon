...
var PassControlBody = /*#__PURE__*/function () {
   ...
   */
  function PassControlBody() {
    _classCallCheck(this, PassControlBody);
    PassControlBody.initialize(this);
  }
   ...
   */
  return _createClass(PassControlBody, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>PassControlBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PassControlBody</code>.
     */
  }, {
    key: "validateJSON",
