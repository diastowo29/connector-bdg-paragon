...
var IntegrationApiKey = /*#__PURE__*/function () {
  ...
  function IntegrationApiKey() {
    ...
    IntegrationApiKey.initialize(this);
  }
   ...
   */
  return _createClass(IntegrationApiKey, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>IntegrationApiKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IntegrationApiKey</code>.
     */
  }, {
    key: "validateJSON",
