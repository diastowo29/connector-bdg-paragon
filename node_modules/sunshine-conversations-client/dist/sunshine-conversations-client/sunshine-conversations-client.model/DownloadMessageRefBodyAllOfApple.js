 ...
 * @version 17.0.0
 */
var DownloadMessageRefBodyAllOfApple = /*#__PURE__*/function () {
  /**
   ...
   */
  function DownloadMessageRefBodyAllOfApple() {
    _classCallCheck(this, DownloadMessageRefBodyAllOfApple);
    DownloadMessageRefBodyAllOfApple.initialize(this);
  }
   ...
   */
  return _createClass(DownloadMessageRefBodyAllOfApple, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>DownloadMessageRefBodyAllOfApple</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DownloadMessageRefBodyAllOfApple</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = DownloadMessageRefBodyAllOfApple;