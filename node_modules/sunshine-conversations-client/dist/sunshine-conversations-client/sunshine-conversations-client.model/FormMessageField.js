...
var FormMessageField = /*#__PURE__*/function () {
   ...
   */
  function FormMessageField() {
    _classCallCheck(this, FormMessageField);
    FormMessageField.initialize(this);
  }
   ...
   */
  return _createClass(FormMessageField, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>FormMessageField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormMessageField</code>.
     */
  }, {
    key: "validateJSON",
