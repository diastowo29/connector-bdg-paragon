...
var _FormMessageFieldAllOf = _interopRequireDefault(require("./FormMessageFieldAllOf"));
 ...
 * @version 16.0.1
 */
var FormMessageField = /*#__PURE__*/function () {
  /**
   ...
   */
  function FormMessageField(type, name, label) {
    _classCallCheck(this, FormMessageField);
    _Field["default"].initialize(this, type, name, label);
    _FormMessageFieldAllOf["default"].initialize(this);
   ...
   */
  return _createClass(FormMessageField, [{
    key: "getType",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _FormMessageFieldAllOf["default"].constructFromObject(data, obj);
 ...
 * @member {String} placeholder
 */
_FormMessageFieldAllOf["default"].prototype['placeholder'] = undefined;
/**
 * The minimum allowed length for the response for a field of type text. Form message only.
 * @member {Number} minSize
 * @default 1
 */
_FormMessageFieldAllOf["default"].prototype['minSize'] = 1;
/**
 * The maximum allowed length for the response for a field of type text. Form message only.
 * @member {Number} maxSize
 * @default 128
 */
_FormMessageFieldAllOf["default"].prototype['maxSize'] = 128;
/**
 * Array of objects representing options for a field of type select.
 * @member {Array.<Object>} options
 */
_FormMessageFieldAllOf["default"].prototype['options'] = undefined;
...
var _default = exports["default"] = FormMessageField;