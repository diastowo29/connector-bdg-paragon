...
var ParticipantJoinBody = /*#__PURE__*/function () {
  ...
  return _createClass(ParticipantJoinBody, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ParticipantJoinBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParticipantJoinBody</code>.
     */
  }, {
    key: "validateJSON",
