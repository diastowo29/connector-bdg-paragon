...
var AttachmentSchema = /*#__PURE__*/function () {
  ...
  return _createClass(AttachmentSchema, [{
    ...
    /**
     * Sets Uploaded attachment’s url.  <aside class=\"notice\"><strong>Note:</strong> An authorization header is required to access the mediaUrl when private attachments are enabled. See [configuring private attachments for messaging](https://developer.zendesk.com/documentation/zendesk-web-widget-sdks/messaging_private_attachments/) guide for more details.</aside> 
     * @param {String} mediaUrl Uploaded attachment’s url.  <aside class=\"notice\"><strong>Note:</strong> An authorization header is required to access the mediaUrl when private attachments are enabled. See [configuring private attachments for messaging](https://developer.zendesk.com/documentation/zendesk-web-widget-sdks/messaging_private_attachments/) guide for more details.</aside> 
     */
  }, {
    key: "setMediaUrl",
