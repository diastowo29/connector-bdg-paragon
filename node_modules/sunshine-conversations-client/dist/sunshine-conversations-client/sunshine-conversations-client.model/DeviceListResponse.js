 ...
 * @version 17.0.0
 */
var DeviceListResponse = /*#__PURE__*/function () {
  /**
  ...
  function DeviceListResponse() {
    _classCallCheck(this, DeviceListResponse);
   ...
   */
  return _createClass(DeviceListResponse, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceListResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceListResponse</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = DeviceListResponse;