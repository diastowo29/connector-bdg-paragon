...
var ExtraChannelOptionsMessenger = /*#__PURE__*/function () {
   ...
   */
  return _createClass(ExtraChannelOptionsMessenger, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ExtraChannelOptionsMessenger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtraChannelOptionsMessenger</code>.
     */
  }, {
    key: "validateJSON",
