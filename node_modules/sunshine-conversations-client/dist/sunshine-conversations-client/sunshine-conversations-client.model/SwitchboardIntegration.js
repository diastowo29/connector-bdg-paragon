...
var SwitchboardIntegration = /*#__PURE__*/function () {
   ...
   */
  function SwitchboardIntegration() {
    _classCallCheck(this, SwitchboardIntegration);
    SwitchboardIntegration.initialize(this);
  }
   ...
   */
  return _createClass(SwitchboardIntegration, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>SwitchboardIntegration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SwitchboardIntegration</code>.
     */
  }, {
    key: "validateJSON",
