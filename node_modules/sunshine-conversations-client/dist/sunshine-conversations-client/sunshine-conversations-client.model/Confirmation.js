...
var Confirmation = /*#__PURE__*/function () {
   ...
   */
  return _createClass(Confirmation, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>Confirmation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Confirmation</code>.
     */
  }, {
    key: "validateJSON",
