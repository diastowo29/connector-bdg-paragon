...
var ParticipantLeaveBody = /*#__PURE__*/function () {
   ...
   */
  return _createClass(ParticipantLeaveBody, [{
    key: "getUserId",
    value:
    /**
 ...
 * @member {String} userId
 */
_ParticipantLeaveBodyUserId["default"].prototype['userId'] = undefined;
// Implement ParticipantLeaveBodyUserExternalId interface:
/**
 * The externalId of the user that will be removed from the conversation. It will return 404 if the user can’t be found. 
 * @member {String} userExternalId
 */
_ParticipantLeaveBodyUserExternalId["default"].prototype['userExternalId'] = undefined;
