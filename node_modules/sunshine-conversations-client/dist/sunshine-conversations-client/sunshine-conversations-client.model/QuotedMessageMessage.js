...
var QuotedMessageMessage = /*#__PURE__*/function () {
   ...
   */
  return _createClass(QuotedMessageMessage, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>QuotedMessageMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QuotedMessageMessage</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = QuotedMessageMessage;