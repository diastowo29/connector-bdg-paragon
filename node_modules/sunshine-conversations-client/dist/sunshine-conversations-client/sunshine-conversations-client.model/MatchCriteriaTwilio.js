...
var MatchCriteriaTwilio = /*#__PURE__*/function () {
   ...
   */
  function MatchCriteriaTwilio() {
    _classCallCheck(this, MatchCriteriaTwilio);
    MatchCriteriaTwilio.initialize(this);
  }
   ...
   */
  return _createClass(MatchCriteriaTwilio, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>MatchCriteriaTwilio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchCriteriaTwilio</code>.
     */
  }, {
    key: "validateJSON",
