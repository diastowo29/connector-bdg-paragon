...
var WebhookCreateBody = /*#__PURE__*/function () {
   ...
   */
  function WebhookCreateBody() {
    _classCallCheck(this, WebhookCreateBody);
    WebhookCreateBody.initialize(this);
  }
  ...
  return _createClass(WebhookCreateBody, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookCreateBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookCreateBody</code>.
     */
  }, {
    key: "validateJSON",
