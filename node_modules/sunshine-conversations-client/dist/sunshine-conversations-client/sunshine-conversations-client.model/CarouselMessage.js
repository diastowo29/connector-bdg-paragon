...
var CarouselMessage = /*#__PURE__*/function () {
  ...
  function CarouselMessage() {
    ...
    CarouselMessage.initialize(this);
  }
   ...
   */
  return _createClass(CarouselMessage, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>CarouselMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CarouselMessage</code>.
     */
  }, {
    key: "validateJSON",
