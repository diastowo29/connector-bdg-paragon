...
var UserUpdateEventAllOfPayload = /*#__PURE__*/function () {
   ...
   */
  return _createClass(UserUpdateEventAllOfPayload, [{
    key: "getUser",
    value:
    /**
    ...
    /**
     * Sets The reason why the user was updated, if applicable. * `authentication` - An unauthenticated user became an [authenticated](https://developer.zendesk.com/documentation/conversations/messaging-platform/users/intro-to-users/) user. * `localeDetection` - A user was updated as a result of automated locale detection on messages sent. 
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/UserUpdateEventAllOfPayload.ReasonEnum} reason The reason why the user was updated, if applicable. * `authentication` - An unauthenticated user became an [authenticated](https://developer.zendesk.com/documentation/conversations/messaging-platform/users/intro-to-users/) user. * `localeDetection` - A user was updated as a result of automated locale detection on messages sent. 
     */
  }, {
    key: "setReason",
...
var _default = exports["default"] = UserUpdateEventAllOfPayload;