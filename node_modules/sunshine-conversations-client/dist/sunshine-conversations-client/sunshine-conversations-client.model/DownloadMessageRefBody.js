 ...
 * @version 17.0.0
 */
var DownloadMessageRefBody = /*#__PURE__*/function () {
  /**
   ...
   */
  function DownloadMessageRefBody() {
    _classCallCheck(this, DownloadMessageRefBody);
    DownloadMessageRefBody.initialize(this);
  }
   ...
   */
  return _createClass(DownloadMessageRefBody, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>DownloadMessageRefBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DownloadMessageRefBody</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = DownloadMessageRefBody;