...
var UserCreateBody = /*#__PURE__*/function () {
  ...
  function UserCreateBody() {
    ...
    UserCreateBody.initialize(this);
  }
   ...
   */
  return _createClass(UserCreateBody, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>UserCreateBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserCreateBody</code>.
     */
  }, {
    key: "validateJSON",
