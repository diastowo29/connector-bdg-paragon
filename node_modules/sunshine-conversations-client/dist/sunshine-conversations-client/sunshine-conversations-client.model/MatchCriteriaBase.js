...
var MatchCriteriaBase = /*#__PURE__*/function () {
   ...
   */
  function MatchCriteriaBase() {
    _classCallCheck(this, MatchCriteriaBase);
    MatchCriteriaBase.initialize(this);
  }
   ...
   */
  return _createClass(MatchCriteriaBase, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>MatchCriteriaBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchCriteriaBase</code>.
     */
  }, {
    key: "validateJSON",
