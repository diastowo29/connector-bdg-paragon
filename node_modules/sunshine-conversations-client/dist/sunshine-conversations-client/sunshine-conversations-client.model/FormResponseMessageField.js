...
var FormResponseMessageField = /*#__PURE__*/function () {
   ...
   */
  function FormResponseMessageField() {
    _classCallCheck(this, FormResponseMessageField);
    FormResponseMessageField.initialize(this);
  }
   ...
   */
  return _createClass(FormResponseMessageField, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>FormResponseMessageField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormResponseMessageField</code>.
     */
  }, {
    key: "validateJSON",
