...
var QuotedMessage = /*#__PURE__*/function () {
   ...
   */
  function QuotedMessage(type) {
    _classCallCheck(this, QuotedMessage);
    _QuotedMessageMessage["default"].initialize(this, type);
    _QuotedMessageExternalMessageId["default"].initialize(this, type);
   ...
   */
  return _createClass(QuotedMessage, [{
    key: "getType",
    value:
    /**
 ...
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/Message} message
 */
_QuotedMessageMessage["default"].prototype['message'] = undefined;
...
var _default = exports["default"] = QuotedMessage;