...
var User = /*#__PURE__*/function () {
  ...
  return _createClass(User, [{
    ...
    key: "setZendeskId",
    value: function setZendeskId(zendeskId) {
    ...
    key: "getToBeRetained",
    value: function getToBeRetained() {
    ...
    key: "setToBeRetained",
    value: function setToBeRetained(toBeRetained) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('authenticated')) {
          obj['authenticated'] = _ApiClient["default"].convertToType(data['authenticated'], 'Boolean');
        }
        if (data.hasOwnProperty('externalId')) {
          obj['externalId'] = _ApiClient["default"].convertToType(data['externalId'], 'String');
        }
        if (data.hasOwnProperty('zendeskId')) {
          obj['zendeskId'] = _ApiClient["default"].convertToType(data['zendeskId'], 'String');
        }
        ...
        if (data.hasOwnProperty('toBeRetained')) {
          obj['toBeRetained'] = _ApiClient["default"].convertToType(data['toBeRetained'], 'Boolean');
        }
 ...
 * @member {Boolean} authenticated
 */
_UserTruncated["default"].prototype['authenticated'] = undefined;
/**
 * An optional ID that can also be used to retrieve the user. 
 * @member {String} externalId
 */
 ...
 * @member {String} zendeskId
 */
_UserTruncated["default"].prototype['zendeskId'] = undefined;
 ...
 * @member {Boolean} toBeRetained
 */
_UserAllOf["default"].prototype['toBeRetained'] = undefined;
/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/Profile} profile
 */
