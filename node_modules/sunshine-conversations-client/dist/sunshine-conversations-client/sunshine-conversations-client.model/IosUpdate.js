...
var IosUpdate = /*#__PURE__*/function () {
   ...
   */
  return _createClass(IosUpdate, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>IosUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IosUpdate</code>.
     */
  }, {
    key: "validateJSON",
