...
var Content = /*#__PURE__*/function () {
   ...
   * @param template {Object} The whatsapp template message to send. For more information, consult the [guide](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/message-overrides/#template-messages). `schema` must be set to `whatsapp`.
   */
  ...
  return _createClass(Content, [{
    ...
    key: "setHtmlText",
    value: function setHtmlText(htmlText) {
    ...
    key: "setMarkdownText",
    value: function setMarkdownText(markdownText) {
    ...
    /**
         * Returns The URL for media, such as an image, attached to the message. <aside class=\"notice\"><strong>Note:</strong> An authorization header is required to access the mediaUrl when private attachments are enabled. See [configuring private attachments for messaging](https://developer.zendesk.com/documentation/zendesk-web-widget-sdks/messaging_private_attachments/) guide for more details.</aside> 
         * @return {String}
         */
  }, {
    key: "getMediaUrl",
    ...
    /**
     * Sets The URL for media, such as an image, attached to the message. <aside class=\"notice\"><strong>Note:</strong> An authorization header is required to access the mediaUrl when private attachments are enabled. See [configuring private attachments for messaging](https://developer.zendesk.com/documentation/zendesk-web-widget-sdks/messaging_private_attachments/) guide for more details.</aside> 
     * @param {String} mediaUrl The URL for media, such as an image, attached to the message. <aside class=\"notice\"><strong>Note:</strong> An authorization header is required to access the mediaUrl when private attachments are enabled. See [configuring private attachments for messaging](https://developer.zendesk.com/documentation/zendesk-web-widget-sdks/messaging_private_attachments/) guide for more details.</aside> 
     */
  }, {
    key: "setMediaUrl",
    ...
    key: "getAttachmentId",
    value: function getAttachmentId() {
    ...
    key: "setAttachmentId",
    value: function setAttachmentId(attachmentId) {
    ...
    /**
         * Returns The whatsapp template message to send. For more information, consult the [guide](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/message-overrides/#template-messages). `schema` must be set to `whatsapp`.
         * @return {Object}
         */
  }, {
    key: "getTemplate",
    ...
    /**
     * Sets The whatsapp template message to send. For more information, consult the [guide](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/message-overrides/#template-messages). `schema` must be set to `whatsapp`.
     * @param {Object} template The whatsapp template message to send. For more information, consult the [guide](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/message-overrides/#template-messages). `schema` must be set to `whatsapp`.
     */
  }, {
    key: "setTemplate",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('htmlText')) {
          obj['htmlText'] = _ApiClient["default"].convertToType(data['htmlText'], 'String');
        }
        ...
        if (data.hasOwnProperty('markdownText')) {
          obj['markdownText'] = _ApiClient["default"].convertToType(data['markdownText'], 'String');
        }
 ...
 * @member {String} htmlText
 */
_TextMessage["default"].prototype['htmlText'] = undefined;
/**
 * When set to true, the chat input will be disabled on supported client implementations when the message is the most recent one in the history. Can be used for guided flows or to temporarily disable the user's ability to send messages in the conversation.
 * @member {Boolean} blockChatInput
 */
_TextMessage["default"].prototype['blockChatInput'] = undefined;
/**
 * Markdown text content of the message. Can be provided in place of `text`. Cannot be used with `htmlText`. Will be converted to `htmlText` upon reception. If converted `htmlText` exceeds 4096 characters, the message will be rejected. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#rich-text) documentation for more information.
 * @member {String} markdownText
 */
_TextMessage["default"].prototype['markdownText'] = undefined;
/**
 ...
 * @member {Boolean} blockChatInput
 */
_CarouselMessage["default"].prototype['blockChatInput'] = undefined;
/**
 * An array of objects representing the items associated with the message. Only present in carousel and list type messages.
 * @member {Array.<module:sunshine-conversations-client/sunshine-conversations-client.model/Item>} items
 */
 ...
 * @member {Boolean} blockChatInput
 */
_FileMessage["default"].prototype['blockChatInput'] = undefined;
/**
 * HTML text content of the message. Can be provided in place of `text`. Cannot be used with `markdownText`. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#rich-text) documentation for more information.
 * @member {String} htmlText
 */
_FileMessage["default"].prototype['htmlText'] = undefined;
/**
 * Markdown text content of the message. Can be provided in place of `text`. Cannot be used with `htmlText`. Will be converted to `htmlText` upon reception. If converted `htmlText` exceeds 4096 characters, the message will be rejected. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#rich-text) documentation for more information.
 * @member {String} markdownText
 */
_FileMessage["default"].prototype['markdownText'] = undefined;
/**
 * An identifier used by Sunshine Conversations for internal purposes.
 * @member {String} attachmentId
 */
_FileMessage["default"].prototype['attachmentId'] = undefined;
 ...
 * @member {Boolean} blockChatInput
 */
_ImageMessage["default"].prototype['blockChatInput'] = undefined;
/**
 * HTML text content of the message. Can be provided in place of `text`. Cannot be used with `markdownText`. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#rich-text) documentation for more information.
 * @member {String} htmlText
 */
_ImageMessage["default"].prototype['htmlText'] = undefined;
/**
 * Markdown text content of the message. Can be provided in place of `text`. Cannot be used with `htmlText`. Will be converted to `htmlText` upon reception. If converted `htmlText` exceeds 4096 characters, the message will be rejected. If no `text` is provided, will be converted to `text` upon reception to be displayed on channels that do not support rich text. See [rich text](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/structured-messages/#rich-text) documentation for more information.
 * @member {String} markdownText
 */
_ImageMessage["default"].prototype['markdownText'] = undefined;
/**
 * Array of message actions.
 * @member {Array.<module:sunshine-conversations-client/sunshine-conversations-client.model/Action>} actions
 */
 ...
 * @member {String} attachmentId
 */
_ImageMessage["default"].prototype['attachmentId'] = undefined;
 ...
 * @member {Boolean} blockChatInput
 */
_ListMessage["default"].prototype['blockChatInput'] = undefined;
/**
 * An array of objects representing the items associated with the message. Only present in carousel and list type messages.
 * @member {Array.<module:sunshine-conversations-client/sunshine-conversations-client.model/Item>} items
 */
 ...
 * @member {Boolean} blockChatInput
 */
_LocationMessage["default"].prototype['blockChatInput'] = undefined;
/**
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/LocationMessageCoordinates} coordinates
 */
 ...
 * @member {Boolean} blockChatInput
 */
_TemplateMessage["default"].prototype['blockChatInput'] = undefined;
/**
 * The whatsapp template message to send. For more information, consult the [guide](https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/message-overrides/#template-messages). `schema` must be set to `whatsapp`.
 * @member {Object} template
 */
