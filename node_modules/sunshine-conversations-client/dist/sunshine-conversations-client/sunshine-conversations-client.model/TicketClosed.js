 ...
 * @version 17.0.0
 */
var TicketClosed = /*#__PURE__*/function () {
  /**
  ...
  function TicketClosed() {
    _classCallCheck(this, TicketClosed);
    TicketClosed.initialize(this);
  }
   ...
   */
  return _createClass(TicketClosed, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>TicketClosed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TicketClosed</code>.
     */
  }, {
    key: "validateJSON",
...
var _default = exports["default"] = TicketClosed;