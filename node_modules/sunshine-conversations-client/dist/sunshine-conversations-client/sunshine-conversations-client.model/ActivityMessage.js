...
var _TicketClosed = _interopRequireDefault(require("./TicketClosed"));
var _TransferToEmail = _interopRequireDefault(require("./TransferToEmail"));
 ...
 * @version 16.0.1
 */
var ActivityMessage = /*#__PURE__*/function () {
  /**
  ...
  function ActivityMessage(type) {
    ...
    _TicketClosed["default"].initialize(this, type);
    _TransferToEmail["default"].initialize(this, type);
   ...
   */
  return _createClass(ActivityMessage, [{
    key: "getType",
    value:
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _TicketClosed["default"].constructFromObject(data, obj);
        _TransferToEmail["default"].constructFromObject(data, obj);
 ...
 */
_TicketClosed["default"].prototype['type'] = 'ticket:closed';
/**
 * No additional data is supplied with the \"ticket:closed\" activity type at this time.
 * @member {Object.<String, Object>} data
 */
_TicketClosed["default"].prototype['data'] = undefined;
 ...
 * @default 'ticket:transfer:email'
 */
_TransferToEmail["default"].prototype['type'] = 'ticket:transfer:email';
/**
 * No additional data is supplied with the \"ticket:transfer:email\" activity type at this time.
 * @member {Object.<String, Object>} data
 */
_TransferToEmail["default"].prototype['data'] = undefined;
var _default = exports["default"] = ActivityMessage;