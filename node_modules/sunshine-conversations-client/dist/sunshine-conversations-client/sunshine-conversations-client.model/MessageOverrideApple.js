...
var _AppleMessageOverridePayload = _interopRequireDefault(require("./AppleMessageOverridePayload"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('apple')) {
          obj['apple'] = _AppleMessageOverridePayload["default"].constructFromObject(data['apple']);
        }
      }
      return obj;
    }
