...
var IntegrationUpdate = /*#__PURE__*/function () {
  ...
  return _createClass(IntegrationUpdate, [{
    ...
    key: "getDefaultResponderId",
    value: function getDefaultResponderId() {
    ...
    key: "setDefaultResponderId",
    value: function setDefaultResponderId(defaultResponderId) {
    ...
    key: "getAuthenticationMessageSecret",
    value: function getAuthenticationMessageSecret() {
    ...
    key: "setAuthenticationMessageSecret",
    value: function setAuthenticationMessageSecret(authenticationMessageSecret) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('defaultResponderId')) {
          obj['defaultResponderId'] = _ApiClient["default"].convertToType(data['defaultResponderId'], 'String');
        }
        ...
        if (data.hasOwnProperty('authenticationMessageSecret')) {
          obj['authenticationMessageSecret'] = _ApiClient["default"].convertToType(data['authenticationMessageSecret'], 'String');
        }
 ...
 * @member {String} defaultResponderId
 */
_AndroidUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * Your project ID from your generated private key file.
 * @member {String} projectId
 */
 ...
 * @member {Boolean} canUserSeeConversationList
 */
_AndroidUpdate["default"].prototype['canUserSeeConversationList'] = undefined;
/**
 ...
 * @member {String} defaultResponderId
 */
_AppleUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * A secret used to create the state value when sending Apple authentication 2.0 messages
 * @member {String} authenticationMessageSecret
 */
_AppleUpdate["default"].prototype['authenticationMessageSecret'] = undefined;
 ...
 * @member {String} defaultResponderId
 */
_InstagramUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * A Facebook Page Access Token.
 * @member {String} pageAccessToken
 */
 ...
 * @member {String} defaultResponderId
 */
_IosUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * The binary of your APN certificate base64 encoded.
 * @member {String} certificate
 */
 ...
 * @member {Boolean} canUserSeeConversationList
 */
_IosUpdate["default"].prototype['canUserSeeConversationList'] = undefined;
/**
 ...
 * @member {String} defaultResponderId
 */
_LineUpdate["default"].prototype['defaultResponderId'] = undefined;
 ...
 * @member {String} defaultResponderId
 */
_MailgunUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * A boolean value indicating whether the unsubscribe link should be omitted from outgoing emails. When enabled, it is expected that the business is providing the user a way to unsubscribe by some other means. By default, the unsubscribe link will be included in all outgoing emails.
 * @member {Boolean} hideUnsubscribeLink
 */
 ...
 * @member {String} defaultResponderId
 */
_MessageBirdUpdate["default"].prototype['defaultResponderId'] = undefined;
 ...
 * @member {String} defaultResponderId
 */
_MessengerUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * A Facebook Page Access Token.
 * @member {String} pageAccessToken
 */
 ...
 * @member {String} defaultResponderId
 */
_TelegramUpdate["default"].prototype['defaultResponderId'] = undefined;
 ...
 * @member {String} defaultResponderId
 */
_TwilioUpdate["default"].prototype['defaultResponderId'] = undefined;
 ...
 * @member {String} defaultResponderId
 */
_TwitterUpdate["default"].prototype['defaultResponderId'] = undefined;
 ...
 * @member {String} defaultResponderId
 */
_UnityUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * Allows users to view their list of conversations. By default, the list of conversations will be visible. *This setting only applies to apps where `settings.multiConvoEnabled` is set to `true`*. 
 * @member {Boolean} canUserSeeConversationList
 */
_UnityUpdate["default"].prototype['canUserSeeConversationList'] = undefined;
/**
 ...
 * @member {String} defaultResponderId
 */
_ViberUpdate["default"].prototype['defaultResponderId'] = undefined;
 ...
 * @member {String} defaultResponderId
 */
_WebUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * This color will be used in the messenger header and the button or tab in idle state. Must be a 3 or 6-character hexadecimal color.
 * @member {String} brandColor
 * @default '65758e'
 ...
 * @member {Boolean} canUserSeeConversationList
 */
_WebUpdate["default"].prototype['canUserSeeConversationList'] = undefined;
/**
 * Allows users to create more than one conversation on the web messenger integration.
 * @member {Boolean} canUserCreateMoreConversations
 */
 ...
 * @member {String} defaultResponderId
 */
_WhatsAppUpdate["default"].prototype['defaultResponderId'] = undefined;
/**
 * Specify a fallback language to use when sending WhatsApp message template using the short hand syntax. Defaults to en_US. See WhatsApp documentation for more info.
 * @member {String} hsmFallbackLanguage
 * @default 'en_US'
