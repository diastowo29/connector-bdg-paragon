...
var AttachmentDeleteBody = /*#__PURE__*/function () {
   ...
   */
  function AttachmentDeleteBody() {
    _classCallCheck(this, AttachmentDeleteBody);
    AttachmentDeleteBody.initialize(this);
  }
   ...
   */
  return _createClass(AttachmentDeleteBody, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>AttachmentDeleteBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachmentDeleteBody</code>.
     */
  }, {
    key: "validateJSON",
