...
var FileMessage = /*#__PURE__*/function () {
   ...
   */
  return _createClass(FileMessage, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>FileMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileMessage</code>.
     */
  }, {
    key: "validateJSON",
